# Generated by Django 3.0.7 on 2021-03-18 18:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('coordinate', models.CharField(blank=True, max_length=24, null=True)),
                ('sorten_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='obstsorten.ObstSorten')),
                ('wiese', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='wiese.Wiese')),
            ],
        ),
    ]
